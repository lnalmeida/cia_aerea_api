...
public class ListMaintenanceViewModel
{
    public ListMaintenanceViewModel(int id, DateTime maintenanceDateTime, string? comments, MaintenanceType typeOfMaintenance, int airplaneId)
    {
        Id = id;
